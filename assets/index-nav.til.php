                    ...
                    <div class="d-flex container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myTogglerNav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link nav-all content" href="./assets/inventory.php">
                                            Inventory</a>                
                                </li>
                                    
                                <?php if(isset($_SESSION["u_id"]) && !empty($_SESSION["u_id"])): ?>
                                <li class="nav-item">
                                    <a class="nav-link nav-all content" href="assets/inc/logout.til.php">
                                    Logout</a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link nav-all content" href="./assets/sign-up.til.php">
                                    Sign Up</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link content" href="./assets/login.til.php">
                                    Login</a>
                                </li>
